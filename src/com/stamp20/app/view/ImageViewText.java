...
public class ImageViewText extends LinearLayout  {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mText = a.getString(R.styleable.ImageViewText_text);
        ...
        mTextView.setTextColor(getResources().getColorStateList(a.getResourceId(R.styleable.ImageViewText_textViewColorStateList, -1)));
        ...
        mImageView.setImageResource(a.getResourceId(R.styleable.ImageViewText_imageViewSelectorDrawable, -1));
    ...
    public View.OnClickListener ocl = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if(null != listener){
                listener.onClick(v, ImageViewText.this.getId());
            }
        }
    };
    ...
    public OnClickListenerImageViewText listener;

    public void setOnClickListenerImageViewText(OnClickListenerImageViewText listenerView) {
        this.listener = listenerView;
    }

    public interface OnClickListenerImageViewText {
