...
import com.stamp20.app.filter.AutoAdjustFilter;
import com.stamp20.app.filter.BannerFilter;
import com.stamp20.app.filter.BigBrotherFilter;
import com.stamp20.app.filter.BlackWhiteFilter;
import com.stamp20.app.filter.BlindFilter;
import com.stamp20.app.filter.BlockPrintFilter;
import com.stamp20.app.filter.BrickFilter;
import com.stamp20.app.filter.BrightContrastFilter;
import com.stamp20.app.filter.CleanGlassFilter;
import com.stamp20.app.filter.ColorQuantizeFilter;
import com.stamp20.app.filter.ColorToneFilter;
import com.stamp20.app.filter.ComicFilter;
import com.stamp20.app.filter.EdgeFilter;
import com.stamp20.app.filter.FeatherFilter;
import com.stamp20.app.filter.FillPatternFilter;
import com.stamp20.app.filter.FilmFilter;
import com.stamp20.app.filter.FocusFilter;
import com.stamp20.app.filter.GammaFilter;
import com.stamp20.app.filter.GaussianBlurFilter;
import com.stamp20.app.filter.Gradient;
import com.stamp20.app.filter.HslModifyFilter;
import com.stamp20.app.filter.IImageFilter;
import com.stamp20.app.filter.IllusionFilter;
import com.stamp20.app.filter.InvertFilter;
import com.stamp20.app.filter.LensFlareFilter;
import com.stamp20.app.filter.LightFilter;
import com.stamp20.app.filter.LomoFilter;
import com.stamp20.app.filter.MirrorFilter;
import com.stamp20.app.filter.MistFilter;
import com.stamp20.app.filter.MonitorFilter;
import com.stamp20.app.filter.MosaicFilter;
import com.stamp20.app.filter.NeonFilter;
import com.stamp20.app.filter.NightVisionFilter;
import com.stamp20.app.filter.NoiseFilter;
import com.stamp20.app.filter.OilPaintFilter;
import com.stamp20.app.filter.OldPhotoFilter;
import com.stamp20.app.filter.PaintBorderFilter;
import com.stamp20.app.filter.PixelateFilter;
import com.stamp20.app.filter.PosterizeFilter;
import com.stamp20.app.filter.RadialDistortionFilter;
import com.stamp20.app.filter.RainBowFilter;
import com.stamp20.app.filter.RaiseFrameFilter;
import com.stamp20.app.filter.RectMatrixFilter;
import com.stamp20.app.filter.ReflectionFilter;
import com.stamp20.app.filter.ReliefFilter;
import com.stamp20.app.filter.SaturationModifyFilter;
import com.stamp20.app.filter.SceneFilter;
import com.stamp20.app.filter.SepiaFilter;
import com.stamp20.app.filter.SharpFilter;
import com.stamp20.app.filter.ShiftFilter;
import com.stamp20.app.filter.SmashColorFilter;
import com.stamp20.app.filter.SoftGlowFilter;
import com.stamp20.app.filter.SupernovaFilter;
import com.stamp20.app.filter.ThreeDGridFilter;
import com.stamp20.app.filter.ThresholdFilter;
import com.stamp20.app.filter.TileReflectionFilter;
import com.stamp20.app.filter.TintFilter;
import com.stamp20.app.filter.VideoFilter;
import com.stamp20.app.filter.VignetteFilter;
import com.stamp20.app.filter.VintageFilter;
import com.stamp20.app.filter.WaterWaveFilter;
import com.stamp20.app.filter.XRadiationFilter;
import com.stamp20.app.filter.YCBCrLinearFilter;
import com.stamp20.app.filter.ZoomBlurFilter;
import com.stamp20.app.filter.Distort.BulgeFilter;
import com.stamp20.app.filter.Distort.RippleFilter;
import com.stamp20.app.filter.Distort.TwistFilter;
import com.stamp20.app.filter.Distort.WaveFilter;
