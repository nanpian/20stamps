...
public class GallaryProgressDialog extends ProgressDialog {
	...
	public static GallaryProgressDialog show(Context context, boolean indeterminate, long overtime, boolean cancelable, DialogInterface.OnCancelListener cancelListener){
		GallaryProgressDialog dialog = new Builder(context)
			.setCancelTime(overtime)
	...
	public static class Builder{
         ...
         * 
         * @param time after time (in milliseconds),dialog will be dismissed;
         *            
         */
	...
	interface OnCancelListener extends DialogInterface.OnCancelListener{
        /**
         * This method will be invoked when the dialog is canceled because time over.
         * 
