...
public class ListView2GridViewLayoutAnimationController extends LayoutAnimationController{
    ...
    Animation getTranslateAnimation(float toXDelta, float toYDelta){
         ...
         * 
         * 参数1、参数2 
         *       起点的X相对于动画View的左上角的偏移量
         *       起点的Y相对于动画View的左上角的偏移量
         *       0.0f 0.0f 说明起点没有和动画View有偏差
         * 
         * 参数3、参数4
         *       终点的X相对于动画View的左上角的偏移量
         *       终点的Y相对于动画View的左上角的偏移量
         * */
    ...
    Animation getAnimation(View from, View to, int index){
         ...
         * 因为在activity_cards_template_choose布局中，ListView和GridView是属于同一个RelativeLayout的。
         * 
        ...
        Log.i("xixia", "index:"+index+",fX:"+fromXDelta + ",fY:"+fromYDelta+",tX:"+toXDelta + 
                ",tY:"+toYDelta+",fromWidth:"+fromWidth+",toWidth:"+toWidth+",formHeight:"+formHeight+",toHeight:" + toHeight);
        Log.i("xixia", "---listViewHeight:"+listViewHeight+",listViewWidth:"+listViewWidth+",gridViewHeight:"+gridViewHeight+",gridViewWidth:"+gridViewWidth);

        AnimationSet animationSet = new AnimationSet(true);
        /*
         * 将当前动画View（from）进行移动操作到终结View（to），移动的距离就是(toXDelta - fromXDelta, toYDelta - fromYDelta)
         * 这也是动画View（from）的左上角的移动距离
         * */
        animationSet.addAnimation(getTranslateAnimation(toXDelta - fromXDelta, toYDelta - fromYDelta));
        /*
         * 不理解pivotX和pivotY参数，为什么要这么传递？？？？？？
         * 但是目前的效果是对了
         * */
