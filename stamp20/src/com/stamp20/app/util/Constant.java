...
public class Constant {
    ...
    public static boolean debugCardsActivity() {
        ...
        // adb shell setprop log.tag.stamp20_cards_start V : make this return
        // true
        // adb shell setprop log.tag.stamp20_cards_start S : make this return
        // false
    ...
    public static boolean debugCardsTemplateChooseActivity() {
        /* 是否调试debugCardsActivity */
        // adb shell setprop log.tag.stamp20_template_start V : make this return
        // true
        // adb shell setprop log.tag.stamp20_template_start S : make this return
        // false
    ...
    public static boolean debugMainActivity() {
        ...
        // true
        // adb shell setprop log.tag.stamp20_main_start S : make this return
        // false
    ...
    public static boolean debugXixiaLog() {
        ...
        // adb shell setprop log.tag.stamp20_xixia_log S : make this return
        // false
