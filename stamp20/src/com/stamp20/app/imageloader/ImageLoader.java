...
public class ImageLoader {
     ...
     * @return
     */
    public Bitmap loadNativeImage(ContentResolver resolver, final Uri uri, final Point mPoint, final NativeImageCallBack mCallBack) {

        String path = ImageUtil.getLocalPathFromUri(resolver, uri);
    ...
    public Bitmap loadNetImage(final String url, final Point mPoint, final NativeImageCallBack mCallBack) {
        // 先获取内存中的Bitmap
