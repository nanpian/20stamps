...
public class AboutAdapter extends BaseAdapter {
	...
	private int[] aboutstring = {R.string.about_1,R.string.about_2,R.string.about_3,R.string.about_4,R.string.about_5,
			R.string.about_6,R.string.about_7,R.string.about_8,R.string.about_9,R.string.about_10};
