...
public class OpenGL10ZoomMoveDemo extends Activity {
	...
	class MyScene extends GlObject implements TouchEventHelper.InvalidateCallback{
	    ...
	    public int getCanvasWidth() { return GameSystem.getInstance().getWindowWidth(); }
		public int getCanvasHeight() { return GameSystem.getInstance().getWindowHeight(); }
		public int getBitmapWidth() { return texture.getWidth(); }
		public int getBitmapHeight() { return texture.getHeight(); }
