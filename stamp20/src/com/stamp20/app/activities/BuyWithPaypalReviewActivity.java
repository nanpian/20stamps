...
public class BuyWithPaypalReviewActivity extends Activity implements
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (confirm != null) {
                    try {
                        ...
                        Log.i(this, confirm.getPayment().toJSONObject()
                                .toString(4));
                        /**
                        ...
                        Log.e(this, "an extremely unlikely failure occurred: ",
                                e);
                    }
                }
