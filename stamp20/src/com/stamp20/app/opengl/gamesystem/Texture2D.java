...
public class Texture2D {
	...
	public void draw(GL10 gl, float x, float y)
	{
		...
		// 映射
		FloatBuffer verticleBuffer = floatBufferUtil(new float[]{
			x,y,
			x+mWidth, 0,
			x, y+mHeight,
			x+mWidth, y+mHeight,
		});
		FloatBuffer coordBuffer = floatBufferUtil(new float[]{
			0,0,
			maxU,0,
			0,maxV,
			maxU,maxV,
