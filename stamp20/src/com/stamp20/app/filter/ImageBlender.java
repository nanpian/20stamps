    ...
    public Image Blend(Image source1, Image source2) {
        ...
        for (int x = 0; x < source1.getWidth(); x++) {
            for (int y = 0; y < source1.getHeight(); y++) {
                ...
                case 4: {// Overlay
                    r = (r2 < 0x80) ? (((2 * r1) * r2) / 255)
                            : (255 - (((2 * (255 - r1)) * (255 - r2)) / 255));
                    g = (g2 < 0x80) ? (((2 * g1) * g2) / 255)
                            : (255 - (((2 * (255 - g1)) * (255 - g2)) / 255));
                    b = (b2 < 0x80) ? (((2 * b1) * b2) / 255)
                ...
                case 11: {// LinearLight
                    /*
                     * if (r2 >= 128){ r = r1 + (2 * (r2 - 128)); r = (r > 255)
                     * ? 255 : r; break; } r = r1 + (2 * r2); r = (r < 255) ? 0
                     * : (r - 255);
                     */
                    if (r2 < 128) {
                        r = r1 + (2 * r2);
