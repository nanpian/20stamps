...
public class Setting {
    ...
    public static JSONObject getProductPriceJsonObject(Context mContext) {
        ...
        if (productPriceJsonString != null && !StringUtils.isBlank(productPriceJsonString)) {
            ...
            // Crashlytics.log(Log.ERROR, "case",
            // "Setting getProductPriceJsonObject string is empty ");
        }
        return result;
    }
    ...
    public static boolean supportAnimation() {
        ...
        /*
         * windows animation is not possible due to support FragmentAcitivty
         * doesn't support new startActivityForResult(intent, int, option)
    ...
    // Crashlytics.log(Log.INFO, "case",
    // "Setting GCMRegistrationId string is empty ");
    // return "";
    // }
    // // Check if app was updated; if so, it must clear the registration ID
    // // since the existing regID is not guaranteed to work with the new
    // // app version.
    // int registeredVersion = _s.getInt("RegisteredAppVersion",
    // Integer.MIN_VALUE);
    // int currentVersion = getAppVersion(mContext);
    // if (registeredVersion != currentVersion) {
    // Crashlytics.log(Log.DEBUG, "case",
    // "Setting GCMRegistrationId string is empty ");
    // return "";
    // }
