...
/**
 * Adjusts the shadows and highlights of an image shadows: Increase to lighten
 * shadows, from 0.0 to 1.0, with 0.0 as the default. highlights: Decrease to
 * darken highlights, from 0.0 to 1.0, with 1.0 as the default.
 */
