...
/**
 * crossHatchSpacing: The fractional width of the image to use as the spacing
 * for the crosshatch. The default is 0.03. lineWidth: A relative width for the
...
public class GPUImageCrosshatchFilter extends GPUImageFilter {
    ...
    /**
     * The fractional width of the image to use as the spacing for the
     * crosshatch. The default is 0.03.
     *
     * @param crossHatchSpacing
     *            default 0.03
     */
