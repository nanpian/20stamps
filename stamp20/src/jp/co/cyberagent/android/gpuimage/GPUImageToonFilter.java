...
/**
 * This uses Sobel edge detection to place a black border around objects, and
 * then it quantizes the colors present in the image to give a cartoon-like
...
public class GPUImageToonFilter extends GPUImage3x3TextureSamplingFilter {
    ...
    public void onInit() {
        super.onInit();
        mThresholdLocation = GLES20.glGetUniformLocation(getProgram(),
                "threshold");
        mQuantizationLevelsLocation = GLES20.glGetUniformLocation(getProgram(),
                "quantizationLevels");
    }
    ...
    /**
     * The levels of quantization for the posterization of colors within the
     * scene, with a default of 10.0.
     *
