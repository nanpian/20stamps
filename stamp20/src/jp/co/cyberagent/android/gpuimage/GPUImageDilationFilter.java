...
/**
 * For each pixel, this sets it to the maximum value of the red channel in a
 * rectangular neighborhood extending out dilationRadius pixels from the center.
 * This extends out bright features, and is most commonly used with
 * black-and-white thresholded images.
 */
public class GPUImageDilationFilter extends
    ...
    /**
     * Acceptable values for dilationRadius, which sets the distance in pixels
     * to sample out from the center, are 1, 2, 3, and 4.
     *
     * @param radius
     *            1, 2, 3 or 4
     */
