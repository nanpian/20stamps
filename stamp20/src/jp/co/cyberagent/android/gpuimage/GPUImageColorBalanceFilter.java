...
public class GPUImageColorBalanceFilter extends GPUImageFilter {
    ...
    public void onInit() {
        super.onInit();
        mShadowsLocation = GLES20.glGetUniformLocation(getProgram(),
                "shadowsShift");
        mMidtonesLocation = GLES20.glGetUniformLocation(getProgram(),
                "midtonesShift");
        mHighlightsLocation = GLES20.glGetUniformLocation(getProgram(),
                "highlightsShift");
        mPreserveLuminosityLocation = GLES20.glGetUniformLocation(getProgram(),
                "preserveLuminosity");
    }
